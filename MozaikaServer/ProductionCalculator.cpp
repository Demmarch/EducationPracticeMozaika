...
int ProductionCalculator::calculateOutput(int productTypeId, int materialTypeId, int materialQuantity, double param1, double param2)
{
    ...
    // Согласно заданию[cite: 80], метод должен вернуть -1 при ошибке.
    ...
    // В ТЗ сказано "Коэффициент типа продукции и процент потери... вещественные числа" [cite: 79]
